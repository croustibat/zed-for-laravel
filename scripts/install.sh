...
echo "   3. Start using snippets with Tab completion"
echo "   4. Run tasks with Cmd/Ctrl+Shift+T"
echo ""
echo "💡 Tips:"
...
echo ""
echo "📖 Documentation: https://github.com/YOUR_USERNAME/zed-for-laravel"
echo ""
